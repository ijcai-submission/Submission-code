...
import os
directory='GD1/train/0'
directory2='GD2/train/0'
...
# generate class activation mapping for the top1 prediction
      ...
      img = cv2.imread('testtraingen.jpg')
...
img[:,:,0]=np.multiply(img[:,:,0],heatmap)
img[:,:,1]=np.multiply(img[:,:,1],heatmap)
img[:,:,2]=np.multiply(img[:,:,2],heatmap)
print('img')
#print(img)
